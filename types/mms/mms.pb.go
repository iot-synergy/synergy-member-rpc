...
var file_mms_proto_rawDesc = []byte{
	...
	0x6f, 0x6e, 0x42, 0x09, 0x0a, 0x07, 0x5f, 0x72, 0x65, 0x6d, 0x61, 0x72, 0x6b, 0x32, 0xc8, 0x0e,
	0x0a, 0x03, 0x4d, 0x6d, 0x73, 0x12, 0x29, 0x0a, 0x0c, 0x69, 0x6e, 0x69, 0x74, 0x44, 0x61, 0x74,
	0x61, 0x62, 0x61, 0x73, 0x65, 0x12, 0x0a, 0x2e, 0x6d, 0x6d, 0x73, 0x2e, 0x45, 0x6d, 0x70, 0x74,
	0x79, 0x1a, 0x0d, 0x2e, 0x6d, 0x6d, 0x73, 0x2e, 0x42, 0x61, 0x73, 0x65, 0x52, 0x65, 0x73, 0x70,
	0x12, 0x32, 0x0a, 0x0c, 0x63, 0x72, 0x65, 0x61, 0x74, 0x65, 0x4d, 0x65, 0x6d, 0x62, 0x65, 0x72,
	...
	0x52, 0x65, 0x73, 0x70, 0x12, 0x34, 0x0a, 0x0e, 0x72, 0x65, 0x67, 0x69, 0x73, 0x74, 0x65, 0x72,
	...
	0x73, 0x65, 0x55, 0x55, 0x49, 0x44, 0x52, 0x65, 0x73, 0x70, 0x12, 0x2e, 0x0a, 0x0c, 0x75, 0x70,
	...
	0x73, 0x2e, 0x4d, 0x65, 0x6d, 0x62, 0x65, 0x72, 0x49, 0x6e, 0x66, 0x6f, 0x12, 0x38, 0x0a, 0x10,
...
var file_mms_proto_msgTypes = make([]protoimpl.MessageInfo, 34)
...
var file_mms_proto_depIdxs = []int32{
	...
	0,  // 7: mms.Mms.initDatabase:input_type -> mms.Empty
	10, // 8: mms.Mms.createMember:input_type -> mms.MemberInfo
	10, // 9: mms.Mms.registerMember:input_type -> mms.MemberInfo
	10, // 10: mms.Mms.updateMember:input_type -> mms.MemberInfo
	7,  // 11: mms.Mms.getMemberList:input_type -> mms.MemberListReq
	2,  // 12: mms.Mms.deleteMember:input_type -> mms.UUIDsReq
	30, // 13: mms.Mms.getMemberById:input_type -> mms.UUIDReq
	5,  // 14: mms.Mms.getMemberByUsername:input_type -> mms.UsernameReq
	12, // 15: mms.Mms.createMemberRank:input_type -> mms.MemberRankInfo
	12, // 16: mms.Mms.updateMemberRank:input_type -> mms.MemberRankInfo
	33, // 17: mms.Mms.getMemberRankList:input_type -> mms.MemberRankListReq
	1,  // 18: mms.Mms.getMemberRankById:input_type -> mms.IDReq
	29, // 19: mms.Mms.deleteMemberRank:input_type -> mms.IDsReq
	4,  // 20: mms.Mms.createOauthProvider:input_type -> mms.OauthProviderInfo
	4,  // 21: mms.Mms.updateOauthProvider:input_type -> mms.OauthProviderInfo
	17, // 22: mms.Mms.getOauthProviderList:input_type -> mms.OauthProviderListReq
	1,  // 23: mms.Mms.getOauthProviderById:input_type -> mms.IDReq
	29, // 24: mms.Mms.deleteOauthProvider:input_type -> mms.IDsReq
	18, // 25: mms.Mms.oauthLogin:input_type -> mms.OauthLoginReq
	14, // 26: mms.Mms.oauthCallback:input_type -> mms.CallbackReq
	18, // 27: mms.Mms.wechatMiniProgramLogin:input_type -> mms.OauthLoginReq
	21, // 28: mms.Mms.createToken:input_type -> mms.TokenInfo
	2,  // 29: mms.Mms.deleteToken:input_type -> mms.UUIDsReq
	6,  // 30: mms.Mms.getTokenList:input_type -> mms.TokenListReq
	30, // 31: mms.Mms.getTokenById:input_type -> mms.UUIDReq
	30, // 32: mms.Mms.blockUserAllToken:input_type -> mms.UUIDReq
	21, // 33: mms.Mms.updateToken:input_type -> mms.TokenInfo
	22, // 34: mms.Mms.memberComment:input_type -> mms.commentInfo
	27, // 35: mms.Mms.memberGetCommentList:input_type -> mms.commentListReq
	28, // 36: mms.Mms.memberGetComment:input_type -> mms.commentIdReq
	23, // 37: mms.Mms.replyComment:input_type -> mms.replyInfo
	27, // 38: mms.Mms.adminGetCommentList:input_type -> mms.commentListReq
	28, // 39: mms.Mms.adminGetComment:input_type -> mms.commentIdReq
	25, // 40: mms.Mms.adminGetReplyList:input_type -> mms.replyReq
	19, // 41: mms.Mms.initDatabase:output_type -> mms.BaseResp
	16, // 42: mms.Mms.createMember:output_type -> mms.BaseUUIDResp
	16, // 43: mms.Mms.registerMember:output_type -> mms.BaseUUIDResp
	19, // 44: mms.Mms.updateMember:output_type -> mms.BaseResp
	11, // 45: mms.Mms.getMemberList:output_type -> mms.MemberListResp
	19, // 46: mms.Mms.deleteMember:output_type -> mms.BaseResp
	10, // 47: mms.Mms.getMemberById:output_type -> mms.MemberInfo
	10, // 48: mms.Mms.getMemberByUsername:output_type -> mms.MemberInfo
	3,  // 49: mms.Mms.createMemberRank:output_type -> mms.BaseIDResp
	19, // 50: mms.Mms.updateMemberRank:output_type -> mms.BaseResp
	32, // 51: mms.Mms.getMemberRankList:output_type -> mms.MemberRankListResp
	12, // 52: mms.Mms.getMemberRankById:output_type -> mms.MemberRankInfo
	19, // 53: mms.Mms.deleteMemberRank:output_type -> mms.BaseResp
	3,  // 54: mms.Mms.createOauthProvider:output_type -> mms.BaseIDResp
	19, // 55: mms.Mms.updateOauthProvider:output_type -> mms.BaseResp
	13, // 56: mms.Mms.getOauthProviderList:output_type -> mms.OauthProviderListResp
	4,  // 57: mms.Mms.getOauthProviderById:output_type -> mms.OauthProviderInfo
	19, // 58: mms.Mms.deleteOauthProvider:output_type -> mms.BaseResp
	20, // 59: mms.Mms.oauthLogin:output_type -> mms.OauthRedirectResp
	10, // 60: mms.Mms.oauthCallback:output_type -> mms.MemberInfo
	19, // 61: mms.Mms.wechatMiniProgramLogin:output_type -> mms.BaseResp
	16, // 62: mms.Mms.createToken:output_type -> mms.BaseUUIDResp
	19, // 63: mms.Mms.deleteToken:output_type -> mms.BaseResp
	15, // 64: mms.Mms.getTokenList:output_type -> mms.TokenListResp
	21, // 65: mms.Mms.getTokenById:output_type -> mms.TokenInfo
	19, // 66: mms.Mms.blockUserAllToken:output_type -> mms.BaseResp
	19, // 67: mms.Mms.updateToken:output_type -> mms.BaseResp
	19, // 68: mms.Mms.memberComment:output_type -> mms.BaseResp
	24, // 69: mms.Mms.memberGetCommentList:output_type -> mms.commentList
	22, // 70: mms.Mms.memberGetComment:output_type -> mms.commentInfo
	19, // 71: mms.Mms.replyComment:output_type -> mms.BaseResp
	24, // 72: mms.Mms.adminGetCommentList:output_type -> mms.commentList
	22, // 73: mms.Mms.adminGetComment:output_type -> mms.commentInfo
	26, // 74: mms.Mms.adminGetReplyList:output_type -> mms.replyList
